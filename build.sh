...
TS_VAR=$(date +%s)
docker build --progress plain --platform=linux/arm64/v8 -t registry.service.home.consul/csi-driver-s3:$TS_VAR-arm64 .
docker build --progress plain --platform=linux/amd64 -t registry.service.home.consul/csi-driver-s3:$TS_VAR-amd64 .
